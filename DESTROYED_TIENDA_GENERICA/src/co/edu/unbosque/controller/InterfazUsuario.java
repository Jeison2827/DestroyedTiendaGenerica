...
public class InterfazUsuario{
		...
		private ventana_gestion_ventas ventanaGestionVentas;
		...
		public InterfazUsuario( Controller control ) {
			...
			ventanaGestionVentas = new ventana_gestion_ventas(control);
		...
		public void mostrarVentanaGestionVentas() {
			ventanaGestionVentas.setVisible(true);
		}
		...
		public ventana_gestion_ventas getVentanaGestionVentas() {
			return ventanaGestionVentas;
		}
